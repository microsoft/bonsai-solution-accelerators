...
IF NOT EXIST "C:\mathworks-examples\bonsai-simulink" (
   ...
   echo %date% - %time% - Opening https://github.com/microsoft/bonsai-solution-accelerators/blob/main/energy_management/mw/getting_started_mfg.md >> %startlog%
   powershell.exe -ExecutionPolicy Unrestricted -File C:\startup\logger.ps1 openWalkthrough
   cmd /c start msedge https://github.com/microsoft/bonsai-solution-accelerators/blob/main/energy_management/mw/getting_started_mfg.md
