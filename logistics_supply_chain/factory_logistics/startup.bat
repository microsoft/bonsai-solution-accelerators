...
powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 startAcc3

  REM If the user is already setup, just close
  IF EXIST %USERPROFILE%\.AnyLogicPLE\anylogic6.license (
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 exitConfigured
     exit /b
  ) ELSE (
     ...
     IF NOT EXIST "C:\anylogic-examples\bonsai-anylogic" (
       ...
       IF %mode% == startup (
         ...
         powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 installEdge
       ...
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 clone_bonsai-anylogic
       ...
       IF %mode% == startup (
          pip install bonsai-cli
           ...
           powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 configureWorkspace
       )
       
       REM create the user's brain
       echo %date% - %time% - Running bonsai brain create -n AnyLogic-ABCA >> %startlog%
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 createBrain
       ...
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 updateInkling
       ...
       IF %mode% == startup (
          ...
          cmd /c az login
          powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 azLogin
       )
       ...
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 setAzSubscription
       ...
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 acrLogin
       ...
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 acrBuild
       ...
       powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 addSimPackage
     ...
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 openAlCloud
     ...
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 openBonsai
     ...
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 openWalkthrough
     ...
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 installInkling
     ...
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 configureAnyLogic
     ...
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 setupFirewall
     ...
     IF %mode% == startup (
        ...
        powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 startAnyLogic
        start AnyLogic.exe
     )

     echo EXITING
     echo %date% - %time% - Script complete >> %startlog%
     powershell.exe -ExecutionPolicy Unrestricted -File .\logger.ps1 setupComplete
     exit /b
